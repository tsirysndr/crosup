...
ChromeOS developer environment setup tool"#,
        ...
        .subcommand(
            Command::new("install")
                ...
                .about(
                    "Install developer tools, possible values are: docker, nix, devbox, homebrew, flox, fish, vscode, ble.sh, atuin, tig, fzf, httpie, kubectl, minikube, tilt, zellij, ripgrep, fd, exa, bat, glow",
                ),
        )
}
